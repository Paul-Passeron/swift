// RUN: %target-swift-frontend -print-ast %s -enable-experimental-feature DeriveConformancesViaMacros -load-plugin-library %swift-plugin-dir/libSwiftMacros.dylib | %FileCheck %s
